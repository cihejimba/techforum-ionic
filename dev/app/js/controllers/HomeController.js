 ...
 */
angular.module('app')
    .controller('HomeController', ['$scope','DateService','ConferencesService','$state','$ionicPlatform',"$ionicPopup", function($scope,DateService,ConferencesService,$state,$ionicPlatform,$ionicPopup)
    {
